...
// This file is used as an example of the typical editing that is expected for this project, please see line 255 and onward for information.
                        ...
                        do
                        {
                            ...
                            if (results != null && results.Count > 0)
                            {
                                ...
                                if (ReadCount == 1)
                                {
                                    ...
                                    if (TellCount == 1){ // 7kzlu (This little tag is to easily identify what has been changed from the usual)
                                        Console.WriteLine("Line/File read at: " + holder.PathInfo); // Always use Console.WriteLine to communicate information as this pipes directly to the 
                                        TellCount = 0; // 7kzlu

                                    } // The reason this loop exists, is because for every line read, it runs through this logic 
